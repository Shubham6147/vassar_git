...
for project in all_projects:
    ...
    out_csv_path = 'F:/CROP_STRESS_AP_PROJECTS/NDVI_AP_PROJECTS/' + project + '_zonal.csv'
    # Define the raster (e.g. NDVI_Timeseries)
    input_ras = 'F:/CROP_STRESS_AP_PROJECTS/NDVI_AP_PROJECTS/' + project + '_NDVI_smooth.tif'
    ...
    with rasterio.open(input_ras) as src:
        ...
        for i in range(1, num_bands+1):
            ...
            zone['NDVI'] = [stat['mean'] for stat in band_stats]
            print(date_list[i-1])
    ...
    all_project_data['NDVI'] = all_project_data['NDVI']/10000
